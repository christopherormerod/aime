...
## GenAI Evidence Hub for Assessment
...
1. **Develop Evidence Rubric** – refine and publish a rubric grounded in contemporary measurement standards.

2. **Human Coding of ≥ 250 Studies** – trained coders will apply the rubric, achieving Cohen’s kappa (κ) ≥ 0.80 on a 50-paper calibration set.

3. **Publish Results & Annotated Corpus** – release practitioner guidance, a searchable database of coded studies, and a technical appendix on LLM-based auto-coding (target ≤ 0.05 κ divergence from human ratings).
